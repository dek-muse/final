...
const App = () => {
  ...
  const [filters, setFilters] = useState({ name: '', subject: '', region: 'Nogob', district: '', teacherType: '', yearJoined: '', sex: '', nativeStatus: '' });
    ...
    const fetchTeachersData = async () => {
      try {
        ...
        if (Array.isArray(response.data)) {
          ...
          setFilteredTeachers(response.data.filter(teacher => teacher.region === 'Nogob')); // Filter to only Nogob region
        } else {
  ...
  const handleResetFilters = () => {
    setFilters({ name: '', subject: '', region: 'Nogob', district: '', teacherType: '', yearJoined: '', sex: '', nativeStatus: '' });
  };
