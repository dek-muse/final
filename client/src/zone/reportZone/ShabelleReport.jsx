...
const App = () => {
  ...
  const [filters, setFilters] = useState({ name: '', subject: '', region: 'Shabelle', district: '', teacherType: '', yearJoined: '', sex: '', nativeStatus: '' });
    ...
    const fetchTeachersData = async () => {
      try {
        ...
        if (Array.isArray(response.data)) {
          ...
          setFilteredTeachers(response.data.filter(teacher => teacher.region === 'Shabelle')); // Filter to only Shabelle region
        } else {
  ...
  const handleResetFilters = () => {
    setFilters({ name: '', subject: '', region: 'Shabelle', district: '', teacherType: '', yearJoined: '', sex: '', nativeStatus: '' });
  };
