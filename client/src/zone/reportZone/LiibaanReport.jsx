...
const App = () => {
  ...
  const [filters, setFilters] = useState({ name: '', subject: '', region: 'Liibaan', district: '', teacherType: '', yearJoined: '', sex: '', nativeStatus: '' });
    ...
    const fetchTeachersData = async () => {
      try {
        ...
        if (Array.isArray(response.data)) {
          ...
          setFilteredTeachers(response.data.filter(teacher => teacher.region === 'Liibaan')); // Filter to only Liibaan region
        } else {
  ...
  const handleResetFilters = () => {
    setFilters({ name: '', subject: '', region: 'Liibaan', district: '', teacherType: '', yearJoined: '', sex: '', nativeStatus: '' });
  };
