...
const App = () => {
  ...
  const [filters, setFilters] = useState({ name: '', subject: '', region: 'Qoraxay', district: '', teacherType: '', yearJoined: '', sex: '', nativeStatus: '' });
    ...
    const fetchTeachersData = async () => {
      try {
        ...
        if (Array.isArray(response.data)) {
          ...
          setFilteredTeachers(response.data.filter(teacher => teacher.region === 'Qoraxay')); // Filter to only Qoraxay region
        } else {
  ...
  const handleResetFilters = () => {
    setFilters({ name: '', subject: '', region: 'Qoraxay', district: '', teacherType: '', yearJoined: '', sex: '', nativeStatus: '' });
  };
