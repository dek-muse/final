...
const App = () => {
  ...
  const [filters, setFilters] = useState({ name: '', subject: '', region: 'Erar', district: '', teacherType: '', yearJoined: '', sex: '', nativeStatus: '' });
    ...
    const fetchTeachersData = async () => {
      try {
        ...
        if (Array.isArray(response.data)) {
          ...
          setFilteredTeachers(response.data.filter(teacher => teacher.region === 'Erar')); // Filter to only Erar region
        } else {
  ...
  const handleResetFilters = () => {
    setFilters({ name: '', subject: '', region: 'Erar', district: '', teacherType: '', yearJoined: '', sex: '', nativeStatus: '' });
  };
