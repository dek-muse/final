...
function About() {
  return (
    <div className="p-6 bg-white rounded-lg shadow-lg max-w-3xl mx-auto mt-10">
      <h1 className="text-3xl font-extrabold text-gray-800 mb-4 border-b-2 border-blue-500 pb-2">
        About the Somali Regional State Education Bureau
      </h1>

      {/* Education Philosophy Section */}
      <section className="mb-6">
        <h2 className="text-2xl font-bold text-gray-800 mb-2">Education Philosophy</h2>
      ...
      {/* Values Section */}
      <section className="mb-6">
        <h2 className="text-2xl font-bold text-gray-800 mb-2">Values</h2>
      ...
      {/* Leadership Section */}
      <section className="mb-6">
        <h2 className="text-2xl font-bold text-gray-800 mb-2">Bureau Leadership</h2>
